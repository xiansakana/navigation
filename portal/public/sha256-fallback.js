/** Sync SHA-256 for non-secure contexts (HTTP) where crypto.subtle is unavailable. */
(function (global) {
  function sha256HexBytes(bytes) {
    ...
    var padLen = ((data.length + 9 + 63) >> 6) << 6;
    ...
    return [h0, h1, h2, h3, h4, h5, h6, h7].map(function (n) {
      return n.toString(16).padStart(8, '0');
    }).join('');
  }

  global.portalSha256Hex = function portalSha256Hex(text) {
